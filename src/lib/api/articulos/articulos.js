...
export const checkArticleEnrollment = async (id, authToken) => {
  try {
    const response = await fetchFromAPI(`articulos/${id}/matriculado/`, authToken);
    return response;
  } catch (error) {
...
export const fetchCategorias = (authToken) => fetchFromAPI('categorias-articulos/', authToken);
export const fetchAreas = (authToken) => fetchFromAPI('areas/', authToken);
export const fetchTemas = (authToken) => fetchFromAPI('temas-articulos/', authToken);
export const fetchTipos = (authToken) => fetchFromAPI('tipos-articulos/', authToken);
export const fetchUniversidad = (authToken) => fetchFromAPI('universidades/', authToken);

export const fetchArticlesByArea = (areaId, authToken) => fetchFromAPI(`areas/${areaId}/articulos/`, authToken);
export const fetchArticlesByCategory = (categoryId, authToken) => fetchFromAPI(`categorias-articulos/${categoryId}/articulos/`, authToken);
export const fetchArticlesBySubject = (subjectId, authToken) => fetchFromAPI(`temas-articulos/${subjectId}/articulos/`, authToken);
export const fetchArticlesByType = (typeId, authToken) => fetchFromAPI(`tipos-articulos/${typeId}/articulos/`, authToken);
export const fetchArticlesByUniversity = (universityId, authToken) => fetchFromAPI(`universidades/${universityId}/articulos/`, authToken);



export const fetchLikeStatus = async (articleId, authToken) => {
  try {
    const response = await fetchFromAPI(`articulos/${articleId}/like-status/`, authToken);
    return response;
  } catch (error) {
...
export const updateLikeStatus = async (articleId, isLiked, authToken) => {
  try {
    const response = await fetchFromAPI(`articulos/${articleId}/update-like/`, authToken, {
      method: 'POST',
...
export async function matricularArticulo(articuloId, authToken) {
  try {
    const response = await fetch(`${API_URL}articulos/${articuloId}/matricular/`, {
      method: 'POST',
      headers: {
...
export async function getArticulosFavoritos(userId, authToken) {
  try {
    const response = await fetchFromAPI(`usuarios/${userId}/articulos-favoritos/`, authToken);
...
export async function getArticulosMatriculados(userId, authToken) {
  try {
    const response = await fetchFromAPI(`usuarios/${userId}/articulos-matriculados/`, authToken);
    return response;
  } catch (error) {
...
export async function getComentariosUsuario(userId, authToken) {
  try {
    const response = await fetchFromAPI(`usuarios/${userId}/comentarios/`, authToken);
    if (!Array.isArray(response)) {
      throw new Error('Response is not an array');
    }
    return response;
...
export const postComment = (articleId, userId, content, authToken) =>
  ...
  try {
    const response = await fetchFromAPI(`articulos/${articleId}/solicitar-matricula/`, authToken, {
      method: 'POST',
      body: { reason: reason }
    });
    return response;
...
export const fetchEnrollmentStatus = async (articleId, authToken) => {
  try {
    const response = await fetchFromAPI(`articulos/${articleId}/estado-matricula/`, authToken);
    return response;
  } catch (error) {
...
export const requestCustomArticle = async (authToken, details) => {
  try {
    const response = await fetchFromAPI('solicitar-articulo-personalizado/', authToken, {
      method: 'POST',
...
export const incrementArticleViews = async (articleId, authToken) => {
  try {
    const response = await fetchFromAPI(`articulos/${articleId}/incrementar-vistas/`, authToken, {
      method: 'POST'
    });
    return response;
  } catch (error) {
...
export const rateArticle = async (articleId, rating, authToken) => {
  try {
    const response = await fetchFromAPI(`articulos/${articleId}/calificar/`, authToken, {
      method: 'POST',
      body: { rating: rating }
    });
    return response;
