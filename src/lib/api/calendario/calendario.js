...
export const createCalendario = (data) =>
  fetchWithAuth("calendarios/", { method: "POST", body: JSON.stringify(data) });
export const updateCalendario = (id, data) =>
  fetchWithAuth(`calendarios/${id}/`, {
    method: "PUT",
    body: JSON.stringify(data),
  });
export const deleteCalendario = (id) =>
  fetchWithAuth(`calendarios/${id}/`, { method: "DELETE" });
export const asignarPermisoCalendario = (id, data) =>
  fetchWithAuth(`calendarios/${id}/asignar_permiso/`, {
    method: "POST",
    body: JSON.stringify(data),
  });
export const transferirPropiedadCalendario = (id, data) =>
  fetchWithAuth(`calendarios/${id}/transferir_propiedad/`, {
    method: "POST",
    body: JSON.stringify(data),
  });
...
export const asignarPermisoEvento = (id, data) =>
  fetchWithAuth(`eventos/${id}/asignar_permiso/`, {
    method: "POST",
    body: JSON.stringify(data),
  });
export const transferirPropiedadEvento = (id, data) =>
  fetchWithAuth(`eventos/${id}/transferir_propiedad/`, {
    method: "POST",
    body: JSON.stringify(data),
  });
...
export const marcarNotificacionComoLeida = (id) =>
  fetchWithAuth(`notificaciones/${id}/marcar_como_leida/`, { method: "POST" });
