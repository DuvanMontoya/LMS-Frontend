  ...
  return new Promise((resolve, reject) => {
    if (typeof window !== "undefined" && window.Prism) {
      ...
      prismScript.onload = () => {
        ...
        prismStyle.href =
          "https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/themes/prism-tomorrow.min.css"; // Usar tema Tomorrow Night

        const prismStyleLight = document.createElement("link");
        prismStyleLight.rel = "stylesheet";
        prismStyleLight.href =
          "https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/themes/prism.css"; // Use the default light theme
