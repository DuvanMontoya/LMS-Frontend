    ...
    <div class="program-container">
      {#if isInView}
        <div class="program-header" in:fade={{ duration: 1000 }}>
          ...
          <!-- <h3 class="program-subtitle">Matemáticas</h3> -->
          <p class="program-description">
            Nuestro programa completo abarca todas las áreas fundamentales de matemáticas del currículo colombiano de grados 6° a 11°, diseñado para desarrollar un entendimiento 
